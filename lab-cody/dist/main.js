...
var Dashboard = function (_React$Component) {
  ...
  _createClass(Dashboard, [{
    key: 'addNote',
    value: function addNote(noteObj) {
    ...
    value: function deleteNote(id) {
      ...
      var noteToDelete = this.state.notes.find(function (note) {
        return note.id = id;
      });
      var noteIndex = this.state.notes.indexOf(noteToDelete);
...
/***/ "./src/components/note-create-form.jsx":
/*!*********************************************!*\
  !*** ./src/components/note-create-form.jsx ***!
  \*********************************************/
/*! no static exports found */
...
var NoteForm = function (_React$Component) {
  ...
  _createClass(NoteForm, [{
    ...
    key: 'submitNote',
    value: function submitNote(event) {
      event.preventDefault();
